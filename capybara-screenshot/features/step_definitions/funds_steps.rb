When('I click on funds tab') do
  ...
  Then('I should be redirected to the Funds listing page') do
    expect(page).to have_content("Discover Managed Investments")
    expect(page).to have_content("Detailed research and information available for Australia's leading Managed Funds, ETFs, LICs and LITs")
    sleep(2)
  end
...
Then('all managed funds are displayed in the result') do
  expect(page).to have_content('Discover Managed Funds')
  expect(page).to have_content("Detailed research and information available for Australia's leading managed funds")
...
Then('all ETFs are displayed in the result') do
  expect(page).to have_content('Discover ETFs')
  expect(page).to have_content("Detailed research and information available for Australia's leading ETFs")
...
Then('all LIC funds are displayed in the result') do
  expect(page).to have_content('Discover LICs')
  expect(page).to have_content("Detailed research and information available for Australia's leading LICs")
  expect(page).to have_no_content("MANAGED FUND")
  expect(page).to have_no_content("ETF")
  expect(page).to have_content("LIC")
  expect(page).to have_no_content("LIT")
end
...
Then('all LIT funds are displayed in the result') do
  expect(page).to have_content('Discover LITs')
  expect(page).to have_content("Detailed research and information available for Australia's leading LITs")
  expect(page).to have_no_content("MANAGED FUND")
  expect(page).to have_content("LIT")
end
