...
#CONTRIBUTOR EDITOR page
      When I click on edit my profiles button from the contributor's profile
      Then I should be redirected to the contributor's personal details page
      When I click on the contributor profile and scroll down to the featured wires
      When I click the kebab menu button
      Then I can see the view wire, change and remove options
      When I try to change the featured wire
      Then the featured wire is changed
      When I remove the featured wire
      Then the featured wire should be removed
      When I click on the featured wire one empty textfield
      And select another wire
      Then another first featured wire is set
      When I update my expertise, experience and investment philosophy
      Then the expertise, experience and investment philosophy should be updated in my profile page
      When I update other details to the old one
      Then the details are updated to the old one
        When I update the profile links and disclaimer
        Then the profile links and disclaimer should be updated in my wires page
...
#
# #NOTIFICATIONS
#       When an author I'm following with publish a wire and then comment
#       Then I should be able to receive notifications that the author published and commented on a wire
...
#MY PROFILE
      ...
      When I click the view all wires button
      And it redirects me to the search result for contributors page
