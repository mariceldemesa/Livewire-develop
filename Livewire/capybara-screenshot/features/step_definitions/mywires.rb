...
Then('the wire should show on the editors pick section on the latest page') do
  expect(page).to have_css('a[href="https://develop.livewiremarkets.com/wires/insider-s-guide-to-investing-5k-2021-09-20"]', :minimum=>3)
end
...
Then('the wire should not be shown in editors picks') do
  expect(page).to have_css('a[href="https://develop.livewiremarkets.com/wires/insider-s-guide-to-investing-5k-2021-09-20"]', :minimum=>2)
end
